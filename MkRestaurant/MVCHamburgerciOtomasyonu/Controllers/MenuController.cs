	...
	public class MenuController : Controller
	{
		...
		public async Task<IActionResult> Add(MenuAddDto menuAddDto)
		{
			...
			else
			{
                ...
                _toastNotification.AddSuccessToastMessage(Messages.Menu.Add(menuAddDto.Name), new ToastrOptions { Title = "Successful" });
        ...
        public async Task<IActionResult> Update(MenuUpdateDto menuUpdateDto)
        {
            ...
            else
            {
                ...
                _toastNotification.AddSuccessToastMessage(Messages.Menu.Update(title), new ToastrOptions() { Title = "Successful" });
                return RedirectToAction("Index", "Menu");
            }
        ...
        public async Task<IActionResult> Delete(Guid menuId)
        {
            ...
            _toastNotification.AddSuccessToastMessage(Messages.Menu.Delete(title), new ToastrOptions() { Title = "Successful" });
            return RedirectToAction("Index", "Menu");
        }
        ...
        public async Task<IActionResult> UndoDelete(Guid menuId)
        {
            ...
            _toastNotification.AddSuccessToastMessage(Messages.Menu.UndoDelete(title), new ToastrOptions() { Title = "Successful" });
            return RedirectToAction("Index", "Menu");
        }
