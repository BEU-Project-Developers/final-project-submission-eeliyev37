...
namespace MVCHamburgerciOtomasyonu.Web.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public async Task<IActionResult> UpdateStatusPreparing(Guid orderId)
        {
            ...
            _toastNotification.AddSuccessToastMessage("Order Status Changed to Preparing", new ToastrOptions { Title = "Successful" });
        ...
        public async Task<IActionResult> UpdateStatusOnRoad(Guid orderId)
        {
            ...
            _toastNotification.AddSuccessToastMessage("Order Status Changed to On the Way", new ToastrOptions { Title = "Successful" });
        ...
        public async Task<IActionResult> UpdateStatusOnCancel(Guid orderId)
        {
            ...
            _toastNotification.AddSuccessToastMessage("Order Status Changed to Cancelled", new ToastrOptions { Title = "Successful" });
        ...
        public async Task<IActionResult> UpdateStatusCompleted(Guid orderId)
        {
            ...
            _toastNotification.AddSuccessToastMessage("Order Status Changed to Completed", new ToastrOptions { Title = "Successful" });
        ...
        [HttpGet]
        [Authorize(Roles = $"{RoleConsts.User},{RoleConsts.Superadmin}")]
        ...
        public async Task<IActionResult> Add(OrderAddDto orderAddDto)
        {
            ...
            else
            {
                ...
                _toastNotification.AddSuccessToastMessage("Order Created Successfully", new ToastrOptions { Title = "Successful" });
                return RedirectToAction("UserOrder", "Order");
            }
        ...
        public async Task<IActionResult> Update(OrderUpdateDto ordeUpdateDto)
        {
            if (ModelState.IsValid)
            {
                ...
                _toastNotification.AddSuccessToastMessage("Order Updated Successfully", new ToastrOptions { Title = "Successful" });
            ...
            else
            {
                ...
                var menuSizes = await _menuSizeService.GetAllMenuSizesNonDeletedAsync();
                var extras = await _extraService.GetAllExtrasNonDeletedAsync();
                _toastNotification.AddErrorToastMessage("Order Failed to Update", new ToastrOptions { Title = "Failed" });
        ...
        public async Task<IActionResult> Delete(Guid orderId)
        {
            ...
            _toastNotification.AddSuccessToastMessage("Order Deleted", new ToastrOptions() { Title = "Successful" });
            return RedirectToAction("UserOrder", "Order");
        }
        ...
        public async Task<IActionResult> UndoDelete(Guid orderId)
        {
            ...
            _toastNotification.AddSuccessToastMessage("Order Revoked", new ToastrOptions() { Title = "Successful" });
            return RedirectToAction("UserOrder", "Order");
        }
