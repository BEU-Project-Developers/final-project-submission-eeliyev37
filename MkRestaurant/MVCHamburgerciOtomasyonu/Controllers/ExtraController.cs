    ...
    public class ExtraController : Controller
    {
        ...
        public async Task<IActionResult> Add(ExtraAddDto menuAddDto)
        {
            ...
            else
            {
                ...
                _toastNotification.AddSuccessToastMessage(Messages.Extra.Add(menuAddDto.Name), new ToastrOptions { Title = "Successful" });
        ...
        public async Task<IActionResult> Update(ExtraUpdateDto extraUpdateDto)
        {
            ...
            else
            {
                ...
                _toastNotification.AddSuccessToastMessage(Messages.Extra.Update(title), new ToastrOptions() { Title = "Successful" });
                return RedirectToAction("Index", "Extra");
            }
        ...
        public async Task<IActionResult> Delete(Guid extraId)
        {
            ...
            _toastNotification.AddSuccessToastMessage(Messages.Extra.Delete(title), new ToastrOptions() { Title = "Successful" });
            return RedirectToAction("Index", "Extra");
        }
        ...
        public async Task<IActionResult> UndoDelete(Guid extraId)
        {
            ...
            _toastNotification.AddSuccessToastMessage(Messages.Extra.UndoDelete(title), new ToastrOptions() { Title = "Successful" });
            return RedirectToAction("Index", "Extra");
        }
    }
}
