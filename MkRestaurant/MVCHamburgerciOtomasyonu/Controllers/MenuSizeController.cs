    ...
    public class MenuSizeController : Controller
    {
        ...
        public async Task<IActionResult> AddWithAjax([FromBody] MenuSizeAddDto menuSizeAddDto)
        {
            ...
            if (result.IsValid)
            {
                ...
                _toastNotification.AddSuccessToastMessage(Messages.MenuSize.Add(menuSizeAddDto.SizeName), new ToastrOptions { Title = "Successful" });

                return Json(Messages.MenuSize.Add(menuSizeAddDto.SizeName));
            }
            else
            {
                _toastNotification.AddErrorToastMessage(result.Errors.First().ErrorMessage, new ToastrOptions { Title = "Failed" });
        ...
        public async Task<IActionResult> Update(MenuSizeUpdateDto menuSizeUpdateDto)
        {
            ...
            else
            {
                ...
                _toastNotification.AddSuccessToastMessage(Messages.MenuSize.Update(title), new ToastrOptions() { Title = "Successful" });
                return RedirectToAction("Index", "MenuSize");
            }
        ...
        public async Task<IActionResult> Delete(Guid menuSizeId)
        {
            ...
            _toastNotification.AddSuccessToastMessage(Messages.MenuSize.Delete(title), new ToastrOptions() { Title = "Successful" });
            return RedirectToAction("Index", "MenuSize");
        }
        ...
        public async Task<IActionResult> UndoDelete(Guid menuSizeId)
        {
            ...
            _toastNotification.AddSuccessToastMessage(Messages.MenuSize.UndoDelete(title), new ToastrOptions() { Title = "Successful" });
            return RedirectToAction("Index", "MenuSize");
        }
    }
}
